            ...
            <div className="max-w-5xl mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="p-6 rounded-xl border border-white/10 hover:-translate-1-y hover:border-purple-500/30 hover:sahdow-[0_2px_8px_rgba(59, 130, 246, 0.1)] transition-all">
                        <h3 className="text-xl font-bold mb-2">Placeholder 1</h3>
                        ...
                        <div className="flex flex-wrap gap-2 mb-4">
                            {["React", "Nodes.js", "AWS", "Docker"].map((tech, key) => (
                                <span key={key}
                        ...
                        <div className="flex justify-between items-center">
                            <a href="" className="text-purple-400 hover:text-purple-300 transition-colors my-4">View Project →</a>
                            </div>
                    </div>
                    ...
                    <div className="p-6 rounded-xl border border-white/10 hover:-translate-1-y hover:border-purple-500/30 hover:sahdow-[0_2px_8px_rgba(59, 130, 246, 0.1)] transition-all">
                        <h3 className="text-xl font-bold mb-2">Placeholder 3</h3>
                        <p className="text-gray-400 mb-4">
                            Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt
                            ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea
                        </p>
